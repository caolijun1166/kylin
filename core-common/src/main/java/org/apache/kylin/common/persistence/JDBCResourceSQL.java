...
public class JDBCResourceSQL {
    ...
    public String getCreateIfNeededSql(String tableName) {
        String sql = new MessageFormat(format.getCreateIfNeedSql(), Locale.ROOT)
    ...
    public String getCreateIndexSql(String indexName, String tableName, String indexCol) {
        String sql = new MessageFormat(format.getCreateIndexSql(), Locale.ROOT)
    ...
    public String getKeyEqualSqlString(boolean fetchContent, boolean fetchTimestamp) {
        String sql = new MessageFormat(format.getKeyEqualsSql(), Locale.ROOT)
    ...
    public String getDeletePstatSql() {
        String sql = new MessageFormat(format.getDeletePstatSql(), Locale.ROOT)
                .format(new Object[] { tableName, metaTableKey }, new StringBuffer(), new FieldPosition(0))
                .toString();
        return sql;
    }

    public String getAllResourceSqlString(boolean loadContent) {
        String sql = new MessageFormat(format.getAllResourceSql(), Locale.ROOT).format(
    ...
    public String getReplaceSql() {
        String sql = new MessageFormat(format.getReplaceSql(), Locale.ROOT)
                .format(new Object[] { tableName, metaTableTs, metaTableContent, metaTableKey },
                        new StringBuffer(), new FieldPosition(0))
                .toString();
        return sql;
    }
    ...
    public String getInsertSql() {
        String sql = new MessageFormat(format.getInsertSql(), Locale.ROOT)
                .format(new Object[] { tableName, metaTableKey, metaTableTs, metaTableContent }, new StringBuffer(),
                        new FieldPosition(0))
                .toString();
        return sql;
    ...
    private String getReplaceSqlWithoutContent() {
        String sql = new MessageFormat(format.getReplaceSqlWithoutContent(), Locale.ROOT)
                .format(new Object[] { tableName, metaTableTs, metaTableKey }, new StringBuffer(),
                        new FieldPosition(0))
                .toString();
        return sql;
    }
    ...
    public String getInsertSqlWithoutContent() {
        String sql = new MessageFormat(format.getInsertSqlWithoutContent(), Locale.ROOT)
                .format(new Object[] { tableName, metaTableKey, metaTableTs }, new StringBuffer(),
                        new FieldPosition(0))
                .toString();
        return sql;
    }
    ...
    public String getUpdateSqlWithoutContent() {
        String sql = new MessageFormat(format.getUpdateSqlWithoutContent(), Locale.ROOT)
    ...
    public String getUpdateContentSql() {
        String sql = new MessageFormat(format.getUpdateContentSql(), Locale.ROOT)
